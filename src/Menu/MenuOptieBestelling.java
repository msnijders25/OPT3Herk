...
public class MenuOptieBestelling implements IMenuOptie, IAction {
    int index;
    String tekst;
    IAction iAction;
    boolean isTerug;
    ...
    public MenuOptieBestelling(int index, String tekst, boolean isTerug, IAction iAction) {
    ...
    public MenuOptieBestelling(int index, String tekst, boolean isTerug, MenuHandle submenu) {
        this.isTerug = isTerug;
